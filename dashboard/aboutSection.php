...
<div class="form-section">
  <form action="../controller/AboutController.php" enctype="multipart/form-data" method="post" id="portfolioForm">
    <input type="hidden" name="id" value="<?= $currentAbout['id'] ?? null ?>">
    <input type="hidden" name="oldImage" value="<?= $currentAbout['about_img'] ?? null ?>" >
    ...
    <div class="form-group mt-4 fade-in">
      ...
      <div class="input-icon">
        <i class="fas fa-heading"></i>
        <input value="<?= $currentAbout['about_heading'] ?? '' ?>" name="heading" type="text" class="form-control"
    ...
    <div class="form-group fade-in">
      ...
      <textarea name="details" class="form-control textarea-field" id="details"
        placeholder="Describe your portfolio in detail..."><?= $currentAbout['about_description'] ?? '' ?></textarea>
    </div>
    ...
    <div class="row-group fade-in">
      <div class="form-group">
        ...
        <div class="input-icon">
          <i class="fas fa-mouse-pointer"></i>
          <input value="<?= $currentAbout['cta'] ?? '' ?>" name="cta" type="text" class="form-control" id="cta-one"
      ...
      <div class="form-group">
        ...
        <div class="input-icon">
          <i class="fas fa-link"></i>
          <input value="<?= $currentAbout['cta_link'] ?? '' ?>" name="cta_link" type="url" class="form-control"
    ...
    <div class="form-group fade-in">
      ...
      <div class="file-upload-container">
        <input name="about_img" type="file" id="featured-image">
    ...
    <?php
   if(isset($currentAbout['about_img'])){
    ?>
      <img src="../<?= $currentAbout['about_img'] ?>" alt="Featured Image" class="img-fluid img-preview"
